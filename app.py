...
<section class="view" data-view="dashboard"><div class="title-row"><h1 data-t="todayTitle">脚本推荐</h1><button class="reselect-title" type="button" data-reselect="true" data-t="changePrefs">重新选择偏好</button></div><p class="lead" data-t="todayLead">Abra e escolha um roteiro para ver os detalhes.</p><div class="tags" id="filters"></div><div class="masonry" id="dashboard-feed"></div></section>
