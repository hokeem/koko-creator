...
def public_entry(entry: dict[str, Any], score: int) -> dict[str, Any]:
    ...
    return {
        ...
        "location_tag_pt": str(entry.get("location_tag_pt") or ""),
        "location_tag_confidence": str(entry.get("location_tag_confidence") or ""),
...
function locationLabel(e){{return lang==="zh"?(e.location_tag||""):(e.location_tag_pt||e.location_tag||"")}}
