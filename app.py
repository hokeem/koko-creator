...
<section class="view" data-view="dashboard"><div class="pill" data-t="todayPill">脚本推荐</div><h1 data-t="todayTitle">脚本推荐</h1><p class="lead" data-t="todayLead">Abra, salve e marque o que você vai gravar hoje.</p><div class="quick"><button type="button"><b id="count-new">0</b><span data-t="quickNew">novos</span></button><button data-go="saved"><b id="count-saved">0</b><span data-t="quickSaved">salvos</span></button><button data-go="saved" data-saved-tab="planned"><b id="count-planned">0</b><span data-t="quickPlan">para gravar</span></button></div><div class="tags" id="filters"></div><div class="feed" id="dashboard-feed"></div></section>
