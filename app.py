...
applyLang();setAuthMode("login");show(forceLanding?"home":initialScriptId?"dashboard":hasProfile()?"dashboard":"home");if(initialScriptId)openDetail(initialScriptId);
</script></body></html>"""
