...
def page_html() -> str:
    ...
    profile_override_css += """.featured-card{display:flex!important;flex-direction:column!important;overflow:visible!important}.featured-scroll-area{max-height:min(72vh,680px);overflow:auto;overscroll-behavior:contain;border-radius:24px 24px 18px 18px;background:#fff;scrollbar-width:thin;scrollbar-color:#ff9d66 #fff0e8}.featured-scroll-area::-webkit-scrollbar{width:4px}.featured-scroll-area::-webkit-scrollbar-thumb{background:#ff9d66;border-radius:999px}.featured-scroll-area::-webkit-scrollbar-track{background:#fff0e8}.featured-scroll-area .featured-body{padding-bottom:0!important}.featured-card .inline-script-section{max-height:none!important;overflow:visible!important;-webkit-mask-image:none!important;mask-image:none!important;margin:12px 0 0!important;background:linear-gradient(180deg,#fffffff6,#fff8f1f2)!important}.featured-card .inline-script-section h2{top:0!important}.featured-actions.pick-actions{flex:0 0 auto!important;margin:12px 16px 16px!important}.today-plan-head{display:block!important}.plan-progress-row{display:grid;grid-template-columns:auto 1fr;align-items:center;gap:12px;margin:10px 0 14px;padding:10px 12px;border:1px solid #ff5f0030;border-radius:18px;background:white}.today-plan-progress{display:block!important;border:0!important;background:transparent!important;padding:0!important;font-size:18px!important;line-height:1!important}.plan-progress-track{height:14px;border-radius:999px;background:#fff0e8;overflow:hidden;border:1px solid #ff5f0028}.plan-progress-track i{display:block;height:100%;width:0;background:linear-gradient(90deg,#ff6a00,#27b866);border-radius:999px;transition:width .25s ease}.plan-submit{grid-column:1/-1;margin-top:8px;border-top:1px solid #ff5f0018;padding-top:8px}.plan-submit-label{display:flex;align-items:center;justify-content:center;min-height:34px;border-radius:999px;background:linear-gradient(90deg,#ff6a00,#ff5200);color:white;font-size:12px;font-weight:950;margin-bottom:8px}.plan-card.done .plan-submit-label{background:linear-gradient(90deg,#26b765,#15984d)}@media(max-width:430px){.featured-scroll-area{max-height:70vh}.featured-actions.pick-actions{margin:10px 12px 14px!important}.plan-progress-row{grid-template-columns:1fr;gap:8px}.today-plan-progress{font-size:16px!important}}"""
...
.reward-card{{padding-bottom:12px!important}}.reward-mascot{{right:24px!important;transform:translateY(-2px) scale(.92)!important;transform-origin:right bottom!important}}.reward-track{{height:60px!important;margin-top:8px!important;padding-right:44px!important}}.reward-track:before{{top:34px!important;height:5px!important;background:#ffe1c9!important}}.reward-track i{{top:34px!important;height:5px!important}}.reward-step{{gap:1px!important}}.reward-coin{{width:18px!important;height:18px!important;box-shadow:0 4px 10px #f59b1630!important}}.reward-amount{{font-size:8px!important;line-height:1!important}}.reward-gift{{width:18px!important;height:18px!important;top:22px!important;right:-8px!important;background-color:#fff!important}}.reward-progress-tail{{position:absolute;right:0;top:25px;z-index:5;min-width:38px;height:24px;border-radius:999px;background:#fff;color:#ff5f00;border:1px solid #ffb789;display:grid;place-items:center;font-size:10px;font-weight:950;box-shadow:0 6px 14px #552d0a10}}.reward-card.complete{{background:linear-gradient(135deg,#fffaf5,#fff4e5 45%,#ddfff0)!important}}.reward-apply{{position:relative;z-index:3;margin-top:9px;width:100%;min-height:40px;border:0;border-radius:999px;background:linear-gradient(90deg,#23c466,#0c9f4c);color:#fff;font-size:13px;font-weight:950;box-shadow:0 12px 24px #21b76130}}.today-plan-progress{{white-space:nowrap}}.plan-empty{{border-style:solid!important;background:linear-gradient(135deg,#fff,#fff7f0)!important;color:#1f1f1f!important}}.plan-empty b{{display:block;margin-bottom:5px;color:#ff5f00;font-size:18px}}.plan-empty span{{display:block;color:#69707a;font-size:12px;line-height:1.4}}.featured-slot{{display:block}}.selection-complete{{border:1px solid #ff5f0028;border-radius:28px;background:linear-gradient(135deg,#fff,#fff3e9);padding:22px 16px;text-align:center;box-shadow:0 18px 40px #552d0a14}}.selection-complete h2{{margin:0 0 8px;font-size:24px;line-height:1.1;color:#1f1f1f}}.selection-complete p{{margin:0 0 14px;color:#69707a;font-size:13px;line-height:1.45;font-weight:800}}.selection-complete .primary{{min-height:50px}}.selection-complete .secondary{{margin-top:9px;width:100%;min-height:44px;border-radius:999px;background:#fff;color:#ff5f00;border:1px solid #ff5f0030;font-weight:950}}.view-all-card.dashboard-bottom{{display:none!important}}.profile-stats{{grid-template-columns:repeat(3,1fr)!important}}.profile-data-panel{{margin:10px 0 12px;border:1px solid #ff5f0020;border-radius:20px;background:#fff;padding:12px;box-shadow:0 10px 22px #552d0a0d}}.profile-data-panel h2{{margin:0 0 10px;font-size:17px;line-height:1.1}}.profile-data-grid{{display:grid;grid-template-columns:repeat(3,1fr);gap:8px}}.profile-data-item{{border:1px solid #ff5f0018;border-radius:16px;background:#fff7f0;padding:10px 8px;text-align:center}}.profile-data-item b{{display:block;color:#ff5f00;font-size:19px;line-height:1}}.profile-data-item span{{display:block;margin-top:4px;color:#69707a;font-size:10px;font-weight:850;line-height:1.2}}.featured-card.slide-left{{animation:kokoPickLeft .42s cubic-bezier(.2,.8,.2,1) both!important}}.featured-card.slide-right{{animation:kokoPickRight .42s cubic-bezier(.2,.8,.2,1) both!important}}@keyframes kokoPickLeft{{0%{{transform:translateX(0) rotate(0) scale(1);opacity:1}}100%{{transform:translateX(-120vw) rotate(-8deg) scale(.94);opacity:.08}}}}@keyframes kokoPickRight{{0%{{transform:translateX(0) rotate(0) scale(1);opacity:1}}100%{{transform:translateX(120vw) rotate(8deg) scale(.94);opacity:.08}}}}@media(max-width:380px){{.reward-mascot{{right:0!important}}.reward-coin{{width:22px!important;height:22px!important}}.reward-progress-tail{{font-size:8px;min-width:31px}}.selection-complete h2{{font-size:22px}}.profile-data-grid{{gap:6px}}.profile-data-item b{{font-size:17px}}}}
...
<div class="auth-overlay" id="auth-modal"><button class="icon auth-close" type="button" data-auth-close>×</button><section class="auth-card"><h2 id="auth-title">Entrar</h2><form id="auth-form"><input name="phone" id="auth-phone" inputmode="text" autocomplete="username" placeholder="Telefone ou ID do Kwai"><p class="auth-login-hint" id="auth-login-hint">Use o telefone cadastrado no Kwai ou seu ID do Kwai para entrar.</p><div class="auth-guide" id="auth-guide"><p id="auth-guide-copy">Para liberar sua biblioteca, informe seu ID do Kwai.</p><input name="kwai_id" id="auth-kwai" autocomplete="username" placeholder="@seu_id_no_kwai"><input name="display_name" id="auth-display-name" autocomplete="name" placeholder="Nome do criador"><textarea name="reason" id="auth-reason" placeholder="Por que você quer acessar a Koko?"></textarea></div><button class="auth-submit" type="submit" id="auth-submit">Entrar</button><div class="auth-switch"><span id="auth-switch-copy">Ainda não tem conta?</span> <button type="button" data-auth-toggle id="auth-toggle">Solicitar acesso</button></div></form></section></div>
...
<div class="mission-popup" id="mission-guide"><section class="mission-sheet mission-guide-card"><div class="mission-guide-hero"><span class="mission-guide-kicker" id="mission-guide-kicker">Evento Koko</span><img class="mission-guide-mascot" src="/static/koko-creator-mascot-cutout.png" alt="Koko"><h2 id="mission-guide-title">Ganhe bônus gravando roteiros</h2><p id="mission-guide-copy">Escolha 3 roteiros, grave os vídeos e envie os links para revisão.</p></div><div class="mission-prize"><div class="mission-prize-main"><span class="mission-prize-coin" aria-hidden="true"></span><div><b>US$3</b><span id="mission-guide-prize">A cada 3 vídeos aprovados, você recebe bônus em dinheiro.</span></div></div></div><div class="mission-rule-grid"><div class="mission-rule"><strong id="mission-rule-one-title">3 roteiros aprovados</strong><span id="mission-rule-one-copy">Cada ciclo de 3 conteúdos aprovados libera US$3.</span></div><div class="mission-rule"><strong id="mission-rule-two-title">Tráfego incentivado</strong><span id="mission-rule-two-copy">Todo roteiro regravado recebe apoio de tráfego, podendo chegar a 1.000.000+ visualizações.</span></div><div class="mission-rule gift"><strong id="mission-rule-three-title">Bônus de performance</strong><span id="mission-rule-three-copy">Se o vídeo passar de 100.000 views, você ganha mais US$3.</span></div></div><label class="mission-read-card"><input id="mission-read" type="checkbox"> <span id="mission-read-label">Li e entendi as regras da campanha.</span></label><label class="mission-hide-card"><input id="mission-hide" type="checkbox"> <span id="mission-hide-label">Não mostrar novamente.</span></label><div class="mission-popup-actions"><button class="primary" type="button" id="mission-start" data-mission-guide-close disabled>Confirmar e começar</button></div></section></div>
...
async function handleAuthSubmit(e){{e.preventDefault();const form=new FormData(e.currentTarget);const phone=String(form.get("phone")||"").replace(/\\s+/g,"").trim();const c=authCopy();try{{if(authMode==="register"){{if(!phone){{alert(c.missing);return}}const kwai_id=String(form.get("kwai_id")||"").trim();const reason=String(form.get("reason")||"").trim();if(!kwai_id){{alert(c.kwaiMissing);return}}if(!reason){{alert(c.reasonMissing);return}}const r=await fetch("/api/auth/register",{{method:"POST",headers:{{"Content-Type":"application/json"}},body:JSON.stringify({{phone,kwai_id,reason}})}});const d=await r.json();if(!r.ok)throw new Error(d.error||c.registerFailed);alert(c.registered);setAuthStep("login");document.querySelector("#auth-phone").value=phone;return}}if(authMode==="profile"){{const kwai_id=String(form.get("kwai_id")||"").trim();const display_name=String(form.get("display_name")||"").trim();if(!kwai_id){{alert(c.kwaiMissing);return}}const r=await fetch("/api/me/profile",{{method:"POST",headers:{{"Content-Type":"application/json"}},body:JSON.stringify({{kwai_id,display_name}})}});const d=await r.json();if(!r.ok)throw new Error(d.error||c.notFound);creatorUser=d.account;localStorage.setItem(authKey,JSON.stringify(creatorUser));await loadAccountState();updateCreatorName();profileGateActive=false;closeAuth(true);track("page_view",{{source:"after_profile"}});if(!hasProfile())show("choose");else show("dashboard");return}}if(!phone){{alert(c.missing);return}}const r=await fetch("/api/auth/login",{{method:"POST",headers:{{"Content-Type":"application/json"}},body:JSON.stringify({{phone}})}});const d=await r.json();if(!r.ok)throw new Error(d.error||c.notFound);creatorUser=d.account;localStorage.setItem(authKey,JSON.stringify(creatorUser));await loadAccountState();updateCreatorName();if(requireKwaiProfile("after_login"))return;closeAuth();track("page_view",{{source:"after_login"}});if(!hasProfile())show("choose");else show("dashboard")}}catch(err){{alert(err.message||c.notFound)}}}}
...
function missionDone(id){{return !!submissionFor(id)||ids("finished").has(id)}}
function missionCandidates(){{return entries.slice().sort((a,b)=>dateKey(b).localeCompare(dateKey(a))).slice(0,10)}}
...
function missionWeeklyDone(){{return missionWeekKeys().reduce((sum,key)=>sum+missionPickedEntries(key).filter(e=>missionDone(e.entry_id)).length,0)}}
...
function openMissionGuide(){{const key=`koko_mission_guide_${{missionDayKey()}}`;if(localStorage.getItem("koko_mission_hide")==="1"||sessionStorage.getItem(key)==="1")return;const modal=document.querySelector("#mission-guide");if(!modal)return;const zh=lang==="zh";document.querySelector("#mission-guide-kicker").textContent=zh?"Koko 活动":"Evento Koko";document.querySelector("#mission-guide-title").textContent=zh?"完成翻拍赚取现金奖励":"Ganhe bônus gravando roteiros";document.querySelector("#mission-guide-copy").textContent=zh?"选择脚本、完成翻拍并回传链接，审核通过后即可累计奖励。":"Escolha roteiros, grave os vídeos e envie os links para revisão.";document.querySelector("#mission-guide-prize").textContent=zh?"每 3 条审核通过的视频，可获得 3 美元奖金。":"A cada 3 vídeos aprovados, você recebe bônus de US$3.";document.querySelector("#mission-rule-one-title").textContent=zh?"每 3 条奖励 US$3":"3 vídeos aprovados";document.querySelector("#mission-rule-one-copy").textContent=zh?"每天选择至少 3 个脚本，拍摄后回传，审核通过后解锁奖励。":"Cada ciclo de 3 conteúdos aprovados libera US$3.";document.querySelector("#mission-rule-two-title").textContent=zh?"流量激励，上不封顶":"Tráfego incentivado";document.querySelector("#mission-rule-two-copy").textContent=zh?"所有翻拍脚本都会获得流量支持，播放量最高可达 1,000,000+。":"Todo roteiro regravado recebe apoio de tráfego, podendo chegar a 1.000.000+ visualizações.";document.querySelector("#mission-rule-three-title").textContent=zh?"爆款额外奖励":"Bônus de performance";document.querySelector("#mission-rule-three-copy").textContent=zh?"单条翻拍视频突破 100,000 播放，再额外奖励 US$3。":"Se o vídeo passar de 100.000 views, você ganha mais US$3.";document.querySelector("#mission-read-label").textContent=zh?"我已阅读并理解活动规则。":"Li e entendi as regras da campanha.";document.querySelector("#mission-hide-label").textContent=zh?"不再提示这个活动说明。":"Não mostrar novamente.";document.querySelector("#mission-start").textContent=zh?"确认并开始":"Confirmar e começar";document.querySelector("#mission-read").checked=false;document.querySelector("#mission-hide").checked=false;document.querySelector("#mission-start").disabled=true;modal.classList.add("active")}}
function closeMissionGuide(){{const key=`koko_mission_guide_${{missionDayKey()}}`;sessionStorage.setItem(key,"1");if(document.querySelector("#mission-hide")?.checked)localStorage.setItem("koko_mission_hide","1");document.querySelector("#mission-guide")?.classList.remove("active")}}
...
function selectionRoundComplete(candidates){{return candidates.length&&featuredOffset>=Math.min(10,candidates.length)}}
function allScriptsPanel(){{return `<section class="selection-complete"><h2>${{lang==="zh"?"今日推荐已看完":"Recomendações de hoje concluídas"}}</h2><p>${{lang==="zh"?"可以去拍摄计划里完成回传，也可以继续查看完整脚本库。":"Finalize seu plano de gravação ou abra a biblioteca completa."}}</p><button class="primary" type="button" data-go="all-scripts">${{lang==="zh"?"查看所有脚本":"Todos os roteiros"}}</button><button class="secondary" type="button" data-feature-restart>${{lang==="zh"?"重新看今日推荐":"Rever recomendações"}}</button></section>`}}
...
function rewardBanner(){{const weeklyDone=Math.min(15,missionWeeklyDone());const pct=Math.min(100,Math.round(weeklyDone/15*100));const complete=weeklyDone>=15;const rewards=[3,6,9,12,15];const giftLabel=lang==="zh"?"神秘礼物":"presente";const coins=rewards.map(n=>`<div class="reward-step ${{weeklyDone>=n?"done":""}}"><span class="reward-amount">${{n}} USD</span><span class="reward-coin" aria-hidden="true"></span>${{n===6||n===12?`<span class="reward-gift" title="${{giftLabel}}" aria-label="${{giftLabel}}"></span>`:""}}</div>`).join("");return `<section class="reward-card ${{complete?"complete":""}}"><div class="reward-glow"></div><div class="reward-copy"><h2>${{complete?(lang==="zh"?"本周任务已完成":"Meta semanal concluída"):(lang==="zh"?"完成翻拍赚取现金奖励":"Ganhe bônus gravando roteiros")}}</h2><p>${{complete?(lang==="zh"?"想解锁下一周任务，可以点击申请联系我们。":"Para liberar a próxima semana, toque para solicitar contato."):(lang==="zh"?"每完成 3 条审核通过的视频，就解锁一个奖金节点，还有神秘礼物。":"A cada 3 vídeos aprovados, você libera bônus em dinheiro e presentes surpresa.")}}</p></div><img class="reward-mascot" src="/static/koko-creator-mascot-cutout.png" alt="Koko"><div class="reward-track"><i style="width:${{pct}}%"></i><div class="reward-steps">${{coins}}</div><span class="reward-progress-tail">${{weeklyDone}}/15</span></div>${{complete?`<button class="reward-apply" type="button" data-week-apply>${{lang==="zh"?"申请解锁下一周任务":"Solicitar próxima semana"}}</button>`:""}}</section>`}}
function refreshRewardBanner(){{const old=document.querySelector(".reward-card");if(old)old.outerHTML=rewardBanner()}}
function renderFeaturedAndPlan(){{const candidates=todayCandidates();const slot=document.querySelector("#featured-slot");const plan=document.querySelector("#today-plan-slot");if(!slot||!plan)return;if(!candidates.length){{slot.innerHTML="";plan.innerHTML=todayPlanHtml();return}}if(selectionRoundComplete(candidates)){{slot.innerHTML=allScriptsPanel();plan.innerHTML=todayPlanHtml();return}}const idx=currentFeaturedIndex(candidates);const item=candidates[idx];preloadImagesAround(idx);slot.innerHTML=featuredCard(item,idx,candidates.length);plan.innerHTML=todayPlanHtml();loadInlineScript(item)}}
...
function planCard(e){{const done=missionDone(e.entry_id);const sub=submissionFor(e.entry_id);return `<article class="plan-card ${{done?"done":""}}"><img src="${{esc(scriptImage(e))}}" loading="lazy" alt=""><div><h3>${{esc(ptTitle(e))}}</h3><p>${{esc(questSummary(e))}}</p><button class="masonry-open" type="button" data-scroll-script="${{esc(e.entry_id)}}">${{lang==="zh"?"查看卡片脚本":"Ver roteiro no card"}}</button></div><div class="plan-submit"><div class="plan-submit-label">${{done?(lang==="zh"?"已回传，等待审核":"Enviado, aguardando revisão"):(lang==="zh"?"回传拍摄视频":"Enviar vídeo gravado")}}</div><div class="plan-submit-row"><input type="url" data-submit-url="${{esc(e.entry_id)}}" placeholder="${{t("submitPlaceholder")}}"><button class="primary" type="button" data-submit="${{esc(e.entry_id)}}">${{lang==="zh"?"提交":"Enviar"}}</button></div></div><div class="plan-status" id="submit-status-${{esc(e.entry_id)}}">${{done?(lang==="zh"?"✅ 脚本已上传，等待审核":"✅ Vídeo enviado, aguardando revisão"):(sub?esc(submissionTime(sub)):"")}}</div></article>`}}
...
function profileDataPanel(){{const returned=submissions.length||0;const week=missionWeeklyDone();const savedCount=(workspace.saved||[]).length;return `<section class="profile-data-panel"><h2>${{lang==="zh"?"数据统计":"Dados"}}</h2><div class="profile-data-grid"><div class="profile-data-item"><b>${{returned}}</b><span>${{lang==="zh"?"累计回传":"Vídeos enviados"}}</span></div><div class="profile-data-item"><b>${{week}}</b><span>${{lang==="zh"?"本周完成":"Semana"}}</span></div><div class="profile-data-item"><b>${{savedCount}}</b><span>${{lang==="zh"?"收藏脚本":"Salvos"}}</span></div></div></section>`}}
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self) -> None:
        ...
        if parsed.path == "/api/auth/login":
            ...
            if not account_id:
                self.send_json({"error": "Digite seu telefone ou ID do Kwai"}, status=400)
                return
            account = find_account(account_id)
            if not account:
                self.send_json({"error": "Conta não encontrada. Solicite acesso primeiro."}, status=404)
                return
            if not account or str(account.get("status") or "active") != "active":
