...
function closeMissionGuide(){{if(document.querySelector("#mission-hide")?.checked){{workspace.rewardGuideHidden=true;saveWorkspace()}}document.querySelector("#mission-guide")?.classList.remove("active")}}
