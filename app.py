...
<section class="view" data-view="dashboard"><div class="pill" data-t="todayPill">脚本推荐</div><h1 data-t="todayTitle">脚本推荐</h1><p class="lead" data-t="todayLead">Abra e escolha um roteiro para ver os detalhes.</p><div class="tags" id="filters"></div><div class="masonry" id="dashboard-feed"></div></section>
